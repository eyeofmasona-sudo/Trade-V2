...
const mockUsers = [
  { id: 'usr_001', name: 'Mike Johnson', email: 'mike@example.com', kyc: 'Verified', role: 'PRO', status: 'Active' },
  { id: 'usr_002', name: 'Sarah Connor', email: 'sarah@example.com', kyc: 'Pending', role: 'STUDENT', status: 'Active' },
  { id: 'usr_003', name: 'John Doe', email: 'john@example.com', kyc: 'Rejected', role: 'STUDENT', status: 'Suspended' },
  { id: 'usr_004', name: 'Emma Wilson', email: 'emma@example.com', kyc: 'Verified', role: 'ADMIN', status: 'Active' },
];
