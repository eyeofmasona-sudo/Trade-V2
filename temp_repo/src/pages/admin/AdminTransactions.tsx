...
const mockTxs = [
  { id: 'tx_981', user: 'Mike Johnson', type: 'Deposit', amount: '$5,000.00', status: 'Completed', date: '2023-11-21 14:20' },
  { id: 'tx_982', user: 'Sarah Connor', type: 'Withdrawal', amount: '$1,200.00', status: 'Pending', date: '2023-11-21 15:40' },
];
